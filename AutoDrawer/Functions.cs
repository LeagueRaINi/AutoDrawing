        ...
        public static void ClickMouse(MouseButtons mouseButton, int x, int y, bool down)
        {
            ...
            switch (mouseButton)
            {
                ...
                case MouseButtons.Middle:
                    _Inputs2.U.mi.dwFlags = down ? MOUSEEVENTF.MIDDLEDOWN : MOUSEEVENTF.MIDDLEUP;
                    break;
                case MouseButtons.XButton1:
                case MouseButtons.XButton2:
                    _Inputs2.U.mi.mouseData = (mouseButton == MouseButtons.XButton1) ? 0x0001 : 0x0002;
                    _Inputs2.U.mi.dwFlags = down ? MOUSEEVENTF.XDOWN : MOUSEEVENTF.XUP;
                    break;
            }
